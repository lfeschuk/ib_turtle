...
class TurtlePortfolioManager(bt.Strategy):
    ...
    def next(self):
        # Ensure SPY has 315 days to warm up RS (252), Momentum (63), and SMA (200)
        ...
        if self.active_ticker is None:
            ...
            # If the S&P 500 is below its 200-Day SMA, we stay in cash. No exceptions.
...
def run_portfolio(start, end):
    ...
    # --- The Robust 20-Stock Target List ---
    tickers = [
    ...
    print(f"\nIgniting Macro-Aware OCO Backtest. This will take a moment...")
    cerebro.run()
