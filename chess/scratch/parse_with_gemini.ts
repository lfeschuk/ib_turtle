...
async function run() {
  const pdfPath = "/Users/lfesch/work_files/chess/scratch/pages_106_110.pdf";
  ...
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      contents: [
        ...
        { text: "Parse this PDF content and extract all analytical variations, introduction theory, game fragments, diagrams, and illustrative games as structured JSON conforming to the requested schema. This PDF contains pages 106 to 110 of the book. Please parse all pages in this document." }
      ],
      config: {
    ...
    const outputPath = "/Users/lfesch/work_files/chess/parsed_pages_106_110.json";
